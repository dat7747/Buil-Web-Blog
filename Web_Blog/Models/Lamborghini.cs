...
namespace Web_Blog.Models
{
    ...
    {
        [Key]
        public int LamborghiniID { get; set; }
        ...
        public int LoaiID { get; set; } // Khóa ngoại tới LoaiLamborghini
        public LoaiLamborghini LoaiLamborghini { get; set; } // Điều hướng tới LoaiLamborghini
    }
